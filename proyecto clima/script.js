...
async function fetchWeather(city) {
    ...
    try {
        ...
        humidityEl.textContent = `Humedad: ${data.main.humidity}%`;
        windEl.textContent = `Viento: ${data.wind.speed} m/s`;
...
window.addEventListener('DOMContentLoaded', () => fetchWeather('Buenos Aires, AR'));
